...
class SharingService {
     ...
     */
    async shareEntity(sharerId, data) {
        ...
        const privacyKey = `${data.type}_share`;
     ...
     * Get community feed
     */
    async getCommunityFeed(userId, limit = 20, offset = 0) {
     ...
     */
    async connectSocialAccount(playerId, data) {
     ...
     */
    async getSocialConnections(playerId) {
     ...
     */
    async updatePrivacySettings(playerId, settings) {
     ...
     */
    async getPrivacySettings(playerId) {
     ...
     * Generate share URL
     */
    generateShareUrl(type, entityId) {
     ...
     * Generate social preview data
     */
    async generateSocialPreview(type, entityId) {
        switch (type) {
            case 'session':
