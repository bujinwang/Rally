...
exports.SessionConfigService = void 0;
...
class SessionConfigService {
     ...
     */
    static async upsertConfiguration(sessionId, config) {
        // Merge with defaults
        const fullConfig = { ...sessionConfig_1.DEFAULT_SESSION_CONFIG, ...config };
     ...
     */
    static async getConfiguration(sessionId) {
     ...
     */
    static async getConfigurationWithDefaults(sessionId) {
        const config = await this.getConfiguration(sessionId);
        return config ? { ...sessionConfig_1.DEFAULT_SESSION_CONFIG, ...config } : sessionConfig_1.DEFAULT_SESSION_CONFIG;
    }
    /**
     * Delete session configuration (reset to defaults)
     */
    static async deleteConfiguration(sessionId) {
...
exports.SessionConfigService = SessionConfigService;
//# sourceMappingURL=sessionConfigService.js.map