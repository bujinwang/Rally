...
class FriendsService {
     ...
     */
    async respondToFriendRequest(requestId, senderId, receiverId, accept) {
    ...
    async getFriendStats(userId) {
        ...
        const friendsCount = Array.isArray(friendsCountResult) ? parseInt(friendsCountResult[0].count) || 0 : 0;
        const pendingRequestsCount = Array.isArray(pendingRequestsResult) ? parseInt(pendingRequestsResult[0].count) || 0 : 0;
        const sentRequestsCount = Array.isArray(sentRequestsResult) ? parseInt(sentRequestsResult[0].count) || 0 : 0;
        return {
            friendsCount,
