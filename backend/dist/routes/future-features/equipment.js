...
router.get('/', async (req, res) => {
    try {
        ...
        const equipment = await equipmentService_1.EquipmentService.searchEquipment(filters);
...
router.get('/:id', async (req, res) => {
    try {
        const equipment = await equipmentService_1.EquipmentService.getEquipmentById(req.params.id);
        if (!equipment) {
...
router.put('/:id', async (req, res) => {
    try {
        const equipment = await equipmentService_1.EquipmentService.updateEquipment(req.params.id, req.body);
        res.json({ success: true, data: equipment });
    }
    catch (error) {
...
router.delete('/:id', async (req, res) => {
    try {
        await equipmentService_1.EquipmentService.deleteEquipment(req.params.id);
...
router.post('/:id/reserve', async (req, res) => {
    try {
        ...
        const reservation = await equipmentService_1.EquipmentService.createReservation(reservationRequest, req.body.userId);
...
router.put('/reservations/:reservationId/approve', async (req, res) => {
    try {
        const reservation = await equipmentService_1.EquipmentService.processReservation(req.params.reservationId, true, req.body.approvedBy);
...
router.put('/reservations/:reservationId/reject', async (req, res) => {
    try {
        const reservation = await equipmentService_1.EquipmentService.processReservation(req.params.reservationId, false, req.body.approvedBy);
        res.json({ success: true, data: reservation });
    }
    catch (error) {
...
router.put('/reservations/:reservationId/checkout', async (req, res) => {
    try {
        const reservation = await equipmentService_1.EquipmentService.checkoutEquipment(req.params.reservationId, req.body.checkedOutBy);
        res.json({ success: true, data: reservation });
    }
    catch (error) {
...
router.put('/reservations/:reservationId/return', async (req, res) => {
    try {
        const returnRequest = {
        ...
        const reservation = await equipmentService_1.EquipmentService.returnEquipment(returnRequest, req.body.returnedBy);
        res.json({ success: true, data: reservation });
    }
    catch (error) {
...
router.get('/:id/inventory', async (req, res) => {
    try {
        const inventory = await equipmentService_1.EquipmentService.getEquipmentInventory(req.params.id);
...
router.get('/:id/stats', async (req, res) => {
    try {
        ...
        const stats = await equipmentService_1.EquipmentService.getEquipmentUsageStats(req.params.id, startDate, endDate);
...
router.post('/:id/maintenance', async (req, res) => {
    try {
        ...
        const maintenance = await equipmentService_1.EquipmentService.createMaintenance(req.params.id, maintenanceData);
...
router.put('/maintenance/:maintenanceId/complete', async (req, res) => {
    try {
        const maintenance = await equipmentService_1.EquipmentService.updateMaintenanceStatus(req.params.maintenanceId, 'COMPLETED', req.body.completedBy);
...
router.get('/notifications', async (req, res) => {
    try {
        ...
        const notifications = await equipmentService_1.EquipmentService.getUserNotifications(userId, unreadOnly);
...
router.put('/notifications/:notificationId/read', async (req, res) => {
    try {
        await equipmentService_1.EquipmentService.markNotificationRead(req.params.notificationId);
